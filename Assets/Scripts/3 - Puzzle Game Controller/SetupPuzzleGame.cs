...
public class SetupPuzzleGame : MonoBehaviour {
	...
	void Awake() {
		candyPuzzleSprites = Resources.LoadAll<Sprite> ("Sprites/Game Assets/Level1");
		transportPuzzleSprites = Resources.LoadAll<Sprite> ("Sprites/Game Assets/Level2");
		fruitPuzzleSprites = Resources.LoadAll<Sprite> ("Sprites/Game Assets/Level3");
	...
	public void SetPuzzleButtonsAndAnimators(List<Button> puzzleButtons, List<Animator> puzzleButtonsAnimators) {
        ...
        puzzleGameManager.SetInitialPattern();
